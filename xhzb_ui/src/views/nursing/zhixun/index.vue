    ...
    <div class="history-panel">
      ...
      <ul class="history-list">
        ...
        >
          ...
          <span v-if="!isTempId(item.id)" @click.stop="handleDelete(item.id)"
                style="margin-left:8px;cursor:pointer;display:flex;align-items:center;">
            <svg width="14" height="14" viewBox="0 0 1024 1024" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
                  d="M320 896c0 35.2 28.8 64 64 64h256c35.2 0 64-28.8 64-64V320H320v576zm576-704h-192l-32-64H352l-32 64H128v64h768v-64z"
                  fill="#f56c6c"/>
            </svg>
          </span>
        </li>
