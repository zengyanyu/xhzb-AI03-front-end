...
public interface NursingProjectPlanMapper extends BaseMapper<NursingProjectPlan> {
     ...
     * @return 护理计划和项目关联集合
     */
    List<NursingProjectPlan> selectNursingProjectPlanList(NursingProjectPlan nursingProjectPlan);
     ...
     * @return 结果
     */
    int insertNursingProjectPlan(NursingProjectPlan nursingProjectPlan);
     ...
     * @return 结果
     */
    int updateNursingProjectPlan(NursingProjectPlan nursingProjectPlan);
     ...
     * @return 结果
     */
    int deleteNursingProjectPlanById(Long id);
     ...
     * @return 结果
     */
    int deleteNursingProjectPlanByIds(Long[] ids);
